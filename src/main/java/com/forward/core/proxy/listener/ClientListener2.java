...
public class ClientListener2 implements ChannelFutureListener {

    private Logger logger = LoggerFactory.getLogger(ClientListener2.class);

    private MyClient myClient;

    private SocketAddress socketAddress;

    public ClientListener2() {
    }

    public ClientListener2(MyClient myClient, SocketAddress socketAddress) {
